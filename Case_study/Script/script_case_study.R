...
############ Data import ################
#########################################
setwd("/<YOURLOCALPATH/Research_archive/Case_study")
...
# In this part of the code, the models are fit on the case study data set.
...
source('Script/performance_measures.R')
...
# Save results
saveRDS(results, "Output/cases_study_results.RDS")
...
ggsave("Output/calibration_plots.jpeg", plot = cal_plot)
