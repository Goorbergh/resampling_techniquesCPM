...
├── Case_study (contains all files concerning the case study)
│   ├── Data
│   ├── Output
│   │   
│   ├── README.md
...
│ 
├── README.md
├── Simulation_study (contains all files concerning the simulation study study)
│   ├── Analysis
│   │   ├── Data
│   │   ├── Output
│   │   └── Script
...
│       ├── Output
│       └── Script
├── Software.txt (All info on software used)
